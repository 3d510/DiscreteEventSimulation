public class GlobalSimulation{
	...
	public static void insertEvent(int type, double TimeOfEvent, int component){  // Just to be able to skip dot notation
		eventList.InsertEvent(type, TimeOfEvent, component);
	}
}